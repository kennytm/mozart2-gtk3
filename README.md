**mozart2-gtk3** is a low-level wrapper of the [GTK+3](http://www.gtk.org/) libraries for the Mozart/Oz platform 2.0. This project provides C-style API to the following modules:
